...
export const SidebarEndContent = () => {
  ...
  return (
    <div
      className="absolute bottom-[69] w-full space-y-4 p-4 transition-[padding,bottom] duration-300 data-[authed=true]:bottom-[97] group-data-[state=collapsed]:bottom-[45] group-data-[state=collapsed]:p-2"
