...
type Props = SVGProps<SVGSVGElement> & VariantProps<typeof discordLogo>

export const DiscordLogo = ({ className, color, shadow, ...props }: Props) => (
  <svg
    className={discordLogo({ className, color, shadow })}
    width={71}
    height={55}
    viewBox="0 0 71 55"
