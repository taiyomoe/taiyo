          ...
          className={cn(
            ...
            variant === "default" &&
              cn(
                ...
                position === "left" && "before:rounded-r-[calc(var(--radius-2xl)-1px)]",
                position === "right" && "before:rounded-l-[calc(var(--radius-2xl)-1px)]",
              ),
            variant === "inset" &&
  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        variant === "switch" ? "grid-cols-[1fr_auto] gap-4 pr-1.5" : "grid-cols-[1rem_1fr] pr-4",
        className,
      )}
