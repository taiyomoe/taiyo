...
export const SelectTrigger = ({
  ...
  >
    {children}
    <BaseSelect.Icon className="flex items-center justify-center">
...
export const SelectContent = ({
  ...
  <BaseSelect.Portal>
    <BaseSelect.Positioner
      ...
      sideOffset={4}
    >
      <BaseSelect.ScrollUpArrow className="top-0 z-[1] flex h-4 w-full cursor-default items-center justify-center rounded-md bg-muted text-center text-xs before:absolute before:top-[-100%] before:left-0 before:h-full before:w-full before:content-[''] data-[direction=down]:bottom-0 data-[direction=down]:before:bottom-[-100%]" />
      <BaseSelect.Popup
        className={cn(
      ...
      <BaseSelect.ScrollDownArrow className="bottom-0 z-[1] flex h-4 w-full cursor-default items-center justify-center rounded-md bg-muted text-center text-xs before:absolute before:top-[-100%] before:left-0 before:h-full before:w-full before:content-[''] data-[direction=down]:bottom-0 data-[direction=down]:before:bottom-[-100%]" />
    </BaseSelect.Positioner>
  </BaseSelect.Portal>
)
