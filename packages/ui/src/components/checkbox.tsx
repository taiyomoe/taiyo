...
export const Checkbox = ({
  ...
  <BaseCheckbox.Root
    className={cn(
      "group flex size-5 items-center justify-center gap-2 rounded-[0.25rem] border bg-muted transition checked:border-primary checked:bg-primary hover:cursor-pointer hover:not-disabled:not-checked:border-emphasis active:scale-[0.98]",
