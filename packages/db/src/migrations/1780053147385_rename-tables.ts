...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  await sql`ALTER TABLE "userProfiles" RENAME CONSTRAINT "UserProfile_userId_fkey" TO "userProfiles_userId_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "userLibraries" RENAME CONSTRAINT "UserLibrary_userId_fkey" TO "userLibraries_userId_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "_userFollows" RENAME CONSTRAINT "_UserFollow_A_fkey" TO "_userFollows_A_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "_userFollows" RENAME CONSTRAINT "_UserFollow_B_fkey" TO "_userFollows_B_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "accounts" RENAME CONSTRAINT "Account_userId_fkey" TO "accounts_userId_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "sessions" RENAME CONSTRAINT "Session_userId_fkey" TO "sessions_userId_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "groups" RENAME CONSTRAINT "Group_creatorId_fkey" TO "groups_creatorId_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "staffs" RENAME CONSTRAINT "Staff_creatorId_fkey" TO "staffs_creatorId_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "medias" RENAME CONSTRAINT "Media_creatorId_fkey" TO "medias_creatorId_fkey"`.execute(
    db,
  )

  // --- userHistories (was UserHistory)
  await sql`ALTER TABLE "UserHistory" RENAME TO "userHistories"`.execute(db)
  await sql`ALTER INDEX "UserHistory_mediaId_userId_key" RENAME TO "userHistories_mediaId_userId_key"`.execute(
    db,
  )
  await sql`ALTER TABLE "userHistories" RENAME CONSTRAINT "UserHistory_mediaId_fkey" TO "userHistories_mediaId_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "userHistories" RENAME CONSTRAINT "UserHistory_userId_fkey" TO "userHistories_userId_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "banners" RENAME CONSTRAINT "Banner_mediaId_fkey" TO "banners_mediaId_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "banners" RENAME CONSTRAINT "Banner_uploaderId_fkey" TO "banners_uploaderId_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "covers" RENAME CONSTRAINT "Cover_mediaId_fkey" TO "covers_mediaId_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "covers" RENAME CONSTRAINT "Cover_uploaderId_fkey" TO "covers_uploaderId_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "titles" RENAME CONSTRAINT "Title_creatorId_fkey" TO "titles_creatorId_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "titles" RENAME CONSTRAINT "Title_mediaId_fkey" TO "titles_mediaId_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "chapters" RENAME CONSTRAINT "Chapter_mediaId_fkey" TO "chapters_mediaId_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "chapters" RENAME CONSTRAINT "Chapter_uploaderId_fkey" TO "chapters_uploaderId_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "_chapterToGroups" RENAME CONSTRAINT "_ChapterToGroup_A_fkey" TO "_chapterToGroups_A_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "_chapterToGroups" RENAME CONSTRAINT "_ChapterToGroup_B_fkey" TO "_chapterToGroups_B_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER INDEX "StaffOnMedia_staffId_index" RENAME TO "staffOnMedias_staffId_index"`.execute(
    db,
  )
  await sql`ALTER TABLE "staffOnMedias" RENAME CONSTRAINT "StaffOnMedia_mediaId_fkey" TO "staffOnMedias_mediaId_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "staffOnMedias" RENAME CONSTRAINT "StaffOnMedia_staffId_fkey" TO "staffOnMedias_staffId_fkey"`.execute(
    db,
  )
...
export async function down(db: Kysely<any>): Promise<void> {
  ...
  await sql`ALTER TABLE "staffOnMedias" RENAME CONSTRAINT "staffOnMedias_staffId_fkey" TO "StaffOnMedia_staffId_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "staffOnMedias" RENAME CONSTRAINT "staffOnMedias_mediaId_fkey" TO "StaffOnMedia_mediaId_fkey"`.execute(
    db,
  )
  await sql`ALTER INDEX "staffOnMedias_staffId_index" RENAME TO "StaffOnMedia_staffId_index"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "_chapterToGroups" RENAME CONSTRAINT "_chapterToGroups_B_fkey" TO "_ChapterToGroup_B_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "_chapterToGroups" RENAME CONSTRAINT "_chapterToGroups_A_fkey" TO "_ChapterToGroup_A_fkey"`.execute(
    db,
  )
  ...
  // --- chapters -> Chapter
  await sql`ALTER TABLE "chapters" RENAME CONSTRAINT "chapters_uploaderId_fkey" TO "Chapter_uploaderId_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "chapters" RENAME CONSTRAINT "chapters_mediaId_fkey" TO "Chapter_mediaId_fkey"`.execute(
    db,
  )
  ...
  // --- titles -> Title
  await sql`ALTER TABLE "titles" RENAME CONSTRAINT "titles_mediaId_fkey" TO "Title_mediaId_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "titles" RENAME CONSTRAINT "titles_creatorId_fkey" TO "Title_creatorId_fkey"`.execute(
    db,
  )
  await sql`ALTER INDEX "titles_mediaId_language_priority_key" RENAME TO "Title_mediaId_language_priority_key"`.execute(
    db,
  )
  ...
  // --- covers -> Cover
  await sql`ALTER TABLE "covers" RENAME CONSTRAINT "covers_uploaderId_fkey" TO "Cover_uploaderId_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "covers" RENAME CONSTRAINT "covers_mediaId_fkey" TO "Cover_mediaId_fkey"`.execute(
    db,
  )
  ...
  // --- banners -> Banner
  await sql`ALTER TABLE "banners" RENAME CONSTRAINT "banners_uploaderId_fkey" TO "Banner_uploaderId_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "banners" RENAME CONSTRAINT "banners_mediaId_fkey" TO "Banner_mediaId_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "userHistories" RENAME CONSTRAINT "userHistories_userId_fkey" TO "UserHistory_userId_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "userHistories" RENAME CONSTRAINT "userHistories_mediaId_fkey" TO "UserHistory_mediaId_fkey"`.execute(
    db,
  )
  await sql`ALTER INDEX "userHistories_mediaId_userId_key" RENAME TO "UserHistory_mediaId_userId_key"`.execute(
    db,
  )
  await sql`ALTER TABLE "userHistories" RENAME TO "UserHistory"`.execute(db)

  // --- medias -> Media
  await sql`ALTER TABLE "medias" RENAME CONSTRAINT "medias_creatorId_fkey" TO "Media_creatorId_fkey"`.execute(
    db,
  )
  ...
  // --- staffs -> Staff
  await sql`ALTER TABLE "staffs" RENAME CONSTRAINT "staffs_creatorId_fkey" TO "Staff_creatorId_fkey"`.execute(
    db,
  )
  ...
  // --- groups -> Group
  await sql`ALTER TABLE "groups" RENAME CONSTRAINT "groups_creatorId_fkey" TO "Group_creatorId_fkey"`.execute(
    db,
  )
  ...
  // --- sessions -> Session
  await sql`ALTER TABLE "sessions" RENAME CONSTRAINT "sessions_userId_fkey" TO "Session_userId_fkey"`.execute(
    db,
  )
  ...
  // --- accounts -> Account
  await sql`ALTER TABLE "accounts" RENAME CONSTRAINT "accounts_userId_fkey" TO "Account_userId_fkey"`.execute(
    db,
  )
  await sql`ALTER INDEX "accounts_accountId_providerId_userId_key" RENAME TO "Account_accountId_providerId_userId_key"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "_userFollows" RENAME CONSTRAINT "_userFollows_B_fkey" TO "_UserFollow_B_fkey"`.execute(
    db,
  )
  await sql`ALTER TABLE "_userFollows" RENAME CONSTRAINT "_userFollows_A_fkey" TO "_UserFollow_A_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "userLibraries" RENAME CONSTRAINT "userLibraries_userId_fkey" TO "UserLibrary_userId_fkey"`.execute(
    db,
  )
  ...
  await sql`ALTER TABLE "userProfiles" RENAME CONSTRAINT "userProfiles_userId_fkey" TO "UserProfile_userId_fkey"`.execute(
    db,
  )
  ...
  // --- users -> User
  await sql`ALTER INDEX "users_displayUsername_key" RENAME TO "User_displayUsername_key"`.execute(
    db,
  )
